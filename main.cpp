  ...
  do {
    ...
    case 12: {
      if (choiceRepresentation == 1) {
        ...
        // Exibir a Árvore Geradora Mínima (AGM) obtida pelo algoritmo de
        // Kruskal
        ...
        cout << "Essa opção só está disponível para a representação por lista "
                "de adjacência.\n";
      }
      break;
    }
    case 13: {
      if (choiceRepresentation == 2) {
        ...
        cout << "Essa opção só está disponível para a representação por matriz "
                "de adjacência.\n";
      }
      break;
    }
